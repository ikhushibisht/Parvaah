...
class _FoodScreenState extends State<FoodScreen>
  ...
  double totalAmount = 25000.0; // Set the total amount to be raised
  double collectedAmount = 300.0; // Set the collected amount initially
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: const DecorationImage(
                            image: AssetImage(
                                tFood), // Assuming you have this image in your project
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          ...
                          'Many impoverished individuals lack access to nutritious food, perpetuating cycles of hunger and malnutrition. Your donation can provide sustenance, support food programs, and empower communities, creating lasting change in combating food insecurity and improving lives.',
                          style: TextStyle(
                            fontSize: 16,
                            color:
